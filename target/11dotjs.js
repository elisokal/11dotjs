...
(function (ElevenDotJs) {
    class Demo {
        ...
        static demo() {
            ...
            let td20 = ElevenDotJs.Tables.getCellElement(Demo.componentId, 2, 0);
            td20.colSpan = 3;
            td20.nextSibling.remove();
            td20.nextSibling.remove();
            // Create the code panel
            let tdCode = ElevenDotJs.Tables.getCellElement(Demo.componentId, 1, 1);
            ...
            let td10 = ElevenDotJs.Tables.getCellElement(Demo.componentId, 1, 0);
            ElevenDotJs.DocComposer.compose({
                "h3": {
            ...
            let td12 = ElevenDotJs.Tables.getCellElement(Demo.componentId, 1, 2);
            ElevenDotJs.DocComposer.compose({
                "div": {
