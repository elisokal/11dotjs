...
(function (ElevenDotJs) {
    class Tables {
        static generate(rowCount, columnCount, cellData, cellStyle) {
            const ret = { "table": {} };
        ...
        static demo() {
            ...
            const ui = Tables.generate(10, 8, { "img": { "src": "http://www.shmetaverse.org/images/close.png" } }, "padding: 24px; background-color: gray;");
