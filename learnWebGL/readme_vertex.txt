...
Initialization Functions: initShaderProgram compiles the shaders and links them into a program. loadShader compiles individual shaders. initBuffers creates and initializes the buffer for vertex positions.
...
Compilation
To compile the TypeScript code into JavaScript, ensure your tsconfig.json is set up correctly as mentioned previously. Compile using the TypeScript compiler (tsc):